...
\subsection{Messwerte und Ergebnisse}
\begin{table}[H]
\captionof{table}{Messwerte für $I_D$ bei variierter Spannung $U_G$ und fester Spannung $U_D = 1V$ eines MOS-FETs}
\begin{center}
\begin{tabular}{l|l}
...
\end{figure}
\begin{table}[H]
\captionof{table}{Messwerte für $I_D$ bei variierter Spannung $U_D$ und fester Spannung $U_G = 2.4V$ eines MOS-FETs}
\begin{center}
\begin{tabular}{l|l}
$U_D$ [mV]   &   $I_D$ [mA] \\
\hline
